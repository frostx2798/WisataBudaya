    ...
    return (
        <React.Fragment>
            <Navbar collapseOnSelect expand="lg" className="navbar-custom shadow-sm" fixed="top">
                <Container>
                    <Navbar.Brand as={Link} to="/" className="fw-bold text-white"><i className="fa fa-map-marked-alt"></i> VITB</Navbar.Brand>
                    ...
                    <Nav>
                    <Nav.Link onClick={() => setModal(true)} className="fw-bold text-white me-4"><i className="fa fa-search"></i> PENCARIAN</Nav.Link>
                        {token 
            ...
            >
                ...
                <Modal.Body>
                    <div className="input-group mb-3">
                        ...
                        <button onClick={searchHandler} type="submit" className="btn btn-md btn-success"><i className="fa fa-search"></i> PENCARIAN</button>
                    </div>
                </Modal.Body>
            </Modal>
        </React.Fragment>
