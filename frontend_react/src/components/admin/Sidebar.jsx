    ...
    return (
        <React.Fragment>
            <div className="list-group list-group-flush">
                ...
                <Link className={splitLocation[2] === "beritas" ? "list-group-item list-group-item-action list-group-item-light p-3 text-uppercase active" : "list-group-item list-group-item-action list-group-item-light p-3 text-uppercase"} to="/admin/beritas"><i className="fa fa-newspaper me-2"></i> Berita</Link>
